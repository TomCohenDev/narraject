...
In **Run By Null**, some actions or situations call for a roll so the story moves forward with unexpected results. This chapter explains how to build your dice hand, resolve actions, and use your identity to shape the outcome.
...
**Do not roll** when the task is routine, there is no pressure, or failure just means "nothing happens."

> **GM Tip:** If failure wouldn't be interesting, don't call for a roll. Just say yes.

---

## Step 1: Declare Your Intent

Tell the GM exactly what you want to achieve and _how_ you are doing it. This is the most important step in the entire game because of one golden rule:

### Success = Intent Happens
...
In Run By Null, actions are not locked to specific stats. You use the stat that matches your description.
