...
Characters advance through **Narrative Points (NP)** earned during play. You spend NP to improve your character mechanically and narratively.
...
5. **Unlock Setting-Specific Abilities** (future content - magic, cybernetics, etc.)

**Narrative justification required:** You must explain how your character earned the advancement. See **The Economy** for NP earning and spending details.

---

## Narrative Points Progression Costs
...
Increasing a Stat Rating costs **3 NP** and requires narrative justification.
...
**Player:** "I want to reduce my 'Fear of Fire (Moderate, -2d6)' Burden. Last session, I faced my fear by diving into the burning building to save my teammate. I've been confronting the trauma in downtime. I spend 3 NP."
...
## Setting-Specific Abilities (Future)
...
**For now:** The core Run By Null system does not include setting-specific abilities. They will be released as expansion content.

---

## Progression Pacing

How fast characters advance depends on NP award rate:

### Slow Progression (Gritty Campaigns)
- 1 NP per player per session average
- Characters advance every 2-3 sessions
- Long-term growth, deep immersion

### Standard Progression (Most Campaigns)
- 1-2 NP per player per session average
- Characters advance every 1-2 sessions
- Balanced pacing

### Fast Progression (Heroic/Epic Campaigns)
- 2-3 NP per player per session average (with GM bonus awards)
- Characters advance every session
- Rapid growth, pulp action

**Recommended:** Start with Standard Progression and adjust based on table preference.
...
**Epic Tier (Optional):** Some campaigns allow Rating 6-10 and more Anchors for legendary heroes. These characters are mythic-level.
...
**After Session 10:**
- Character is significantly stronger, with improved stats, better Anchors, and resolved Burdens
- Still balanced (Anchors = Burdens due to Rule of Balance)
- NP cycle continues
...
See **The Economy** chapter for detailed NP award guidelines.

**Quick Tips:**
- Award 1 NP when players engage meaningfully with the narrative
- Aim for 1-2 NP per player per session
- NP should feel earned, not given
- Encourage players to spend NP between sessions (cap at 5 NP)

---

## Quick Reference

**Earn NP:** Play Burdens well, use Narrative Injection creatively, create story moments

**Spend NP:** Between sessions or downtime, with narrative justification

**Costs:** 2-4 NP for most advancements

**Cap:** 5 NP maximum stored

**Rule of Balance:** New Anchors require new Burdens

**Milestone Advancement:** Optional bonus rewards for epic moments

---

## Final Thought

Progression in Run By Null isn't just about getting mechanically stronger. It's about growing your character narratively—facing your Burdens, mastering your skills, and becoming a legend.
