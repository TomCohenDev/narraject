...
NPCs need minimal stats. Following Cypher's lead: one number tells you everything.
...
Give NPCs **Specials**—one-sentence abilities:

- **Pack tactics:** +1d6 with allies
- **Armored:** Reduce Condition severity by 1 level
- **Fast:** Can move between zones as a free action
- **Tough:** Requires one extra Condition to take out
- **Cunning:** Once per scene, force a reroll

Keep it simple. One special per NPC is usually enough.

---

## Motivations

Every NPC should have a **Motivation**—one sentence about what they want:
...
Use motivations to drive NPC behavior. They want something. How does that create conflict?

---

## Threats Beyond Combat
